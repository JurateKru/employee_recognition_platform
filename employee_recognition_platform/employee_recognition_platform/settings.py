"""
Django settings for employee_recognition_platform project.
...
ROOT_URLCONF = 'employee_recognition_platform.urls'
...
WSGI_APPLICATION = 'employee_recognition_platform.wsgi.application'
